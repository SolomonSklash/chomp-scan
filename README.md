...
#### Misc.
* altdns-words.txt - Used for creating domain permutations for [masscan](https://github.com/robertdavidgraham/masscan) to resolve. Taken from [here](https://github.com/infosec-au/altdns/blob/master/words.txt)
